...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['blood_group_name'])) {
    	...
    	$statement->execute(array($_POST['blood_group_name']));
    ...
    if($valid == 1) {
		...
		$statement = $pdo->prepare("INSERT INTO tbl_blood_group (blood_group_name) VALUES (?)");
		$statement->execute(array($_POST['blood_group_name']));

    	$success_message = 'Blood Group is added successfully.';
    }
}
?>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="blood_group_name" autocomplete="off">
							</div>
						</div>
						<div class="form-group">
