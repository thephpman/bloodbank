...
<section class="content">
  	...
  	<div class="row">
    	<div class="col-md-12">
			...
			<p>As you will not change a menu freequently, so we did not make option to edit all items of a menu. You can only change <b>orders.</b> You can create unlimited menus (with dropdown) and delete menus when necessary. You can select a category or page as a menu item or can setup another menu with custom link.</p>
